...
![Pantalla de inicio de sesión de Azure](imgs/Azure1.jpg){height=50%}
...
![Pantalla de inicio de Azure](imgs/Azure2.jpg){height=50%}
...
![Pantalla de Datos Básicos para la creación de un grupo de recursos](imgs/Azure3.jpg){height=50%}

Seguidamente se mostrará la pantalla de Etiquetas, en la cual no se hará nada y solo se hace click en siguiente.

![Pantalla de Etiquetas para la creación de un grupo de recursos](imgs/Azure4.jpg){height=50%}
...
![Búsqueda de "Servidores SQL Server" en la barra de búsqueda](imgs/Azure5.jpg){height=50%}

Una vez entrado en la página de Servidores SQL Server, se deberá realizar click en el botón de "Crear".

![Página principal de Servidores SQL Server](imgs/Azure6.jpg){height=50%}
...
![Página de información básica para la creación del Servidor SQL](imgs/Azure7.jpg){height=50%}
...
![Página de redes para la creación del Servidor SQL](imgs/Azure8.jpg){height=50%}
...
![Página de redes para la creación del Servidor SQL](imgs/Azure9.jpg){height=50%}
...
![Página del servidor SQL recién creado](imgs/Azure12.jpg){height=50%}
...
![Página principal de Máquinas Virtuales](imgs/Azure13.jpg){height=50%}
...
![Página de información básica para la creación de la Máquina Virtual](imgs/Azure14.jpg){height=50%}
...
![Página de discos para la creación de la Máquina Virtual](imgs/Azure15.jpg){height=50%}
...
![Página de Administración para la creación de la Máquina Virtual](imgs/Azure17.jpg){height=50%}
...
![Página principal de las bases de datos SQL](imgs/Azure18.jpg){height=50%}
...
![Página de información básica para la creación de la base de datos SQL](imgs/Azure19.jpg){height=50%}
...
![Página de redes para la creación de la base de datos SQL](imgs/Azure20.jpg){height=50%}
...
![Página de seguridad para la creación de la base de datos SQL](imgs/Azure21.jpg){height=50%}
...
![Página principal de App Services](imgs/Azure22.jpg){height=50%}
...
![Página de información básica para la creación del App Service](imgs/Azure23.jpg){height=50%}
...
![Página de implementación para la creación del App Service](imgs/Azure24.jpg){height=50%}
...
![Página de supervición para la creación del App Service](imgs/Azure25.jpg){height=50%}
...
![Página de cadenas de conexión de la base de datos SQL recién creada](imgs/Azure26.jpg){height=50%}
...
![Página de configuración del App Service creado anteriormente](imgs/Azure27.jpg){height=50%}

![Agregar cadena de conexión al App Service](imgs/Azure28.jpg){height=50%}
...
![Descarga de Archivo RDP de la máquina virtual](imgs/Azure29.jpg){height=50%}
...
![Shell de MongoCompass](imgs/Azure32.jpg){height=50%}
